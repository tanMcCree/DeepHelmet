...
class Ui_MainWindow(QMainWindow):
    ...
    def show_info(self):
        ...
        self.illegal.setText(_translate("MainWindow", "illegal: 0"))
        self.label_2.setText(_translate("MainWindow", "output: True"))
        self.AllPeople.setText(_translate("MainWindow", "all person: " + str(self.all_person)))
        self.WithoutHM.setText(_translate("MainWindow", "person: " + str(self.person)))
        self.WithHM.setText(_translate("MainWindow", "hat: " + str(self.hat)))
    ...
    def calculate(self, line_x, line_y):
        self.slove = line_y - ((self.second_point_y - self.first_point_y) / (
